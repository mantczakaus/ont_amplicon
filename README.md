...
a. [Run the pipeline for the first time](#run-the-pipeline-for-the-first-time)  
b. [Run test data](#run-test-data)  
c. [QC step](#qc-step)  
d. [Preprocessing reads](#preprocessing-reads)  
e. [Clustering step](#clustering-step)  
f. [Primer search](#primer-search)
g. [Blast homology search against NCBI](#blast-homology-search-against-NCBI)
h. [Mapping back to consensus](#mapping-back-to-consensus)
i. [Mapping back to reference](#mapping-back-to-reference)
j. [HTML report](#HTML-report)
